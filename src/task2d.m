...
% f is normal data mahalaonbis transformed by covariance of class 1 l2 data
% g is normal data mahalaonbis transformed by covariance of class 2 l2 data
% h is normal data mahalaonbis transformed by covariance of class 2 l2 data
% i is normal data mahalaonbis transformed by covariance of class 3 l2 data
% j is normal data mahalaonbis transformed by covariance of class 3 l2 data
...
% Save data
save(strjoin({res_path 'task2d.mat'}, filesep), 'idx', 'clusters', 'answers');