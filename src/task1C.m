...
dlmwrite(strjoin({res_path 'means.txt'}, filesep), [mean_training; ...
    mean_class1; mean_class2; mean_class3; mean_l2; ... 
    mean_l2_class1; mean_l2_class2; mean_l2_class3]', 'delimiter','&', 'precision','%.3f');
