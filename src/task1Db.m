...
confusion_plotting(l_test, distance_maha(:, 1), '../pic/unmod_cov_l2', 3);
confusion_plotting(l_test, distance_maha(:, 2), '../pic/unmod_cov_l2_class1', 3);
confusion_plotting(l_test, distance_maha(:, 3), '../pic/unmod_cov_l2_class2', 3);
confusion_plotting(l_test, distance_maha(:, 4), '../pic/unmod_cov_l2_class3', 3);

confusion_plotting(l_test, distance_maha_l2(:, 1), '../pic/mod_cov_l2', 3);
