...
save(strjoin({res_path 'kthreeresults.mat'}, filesep), ...
     'answers_k3_a', 'answers_k3_b', 'answers_k3_c', 'answers_k3_d', ... 
     'answers_k3_e', 'answers_k3_f', 'answers_k3_g', 'answers_k3_h', ...
     'answers_k3_i', 'answers_k3_j', 'l_test');
 
save(strjoin({res_path 'ktenresults.mat'}, filesep), ...
     'answers_k10_a', 'answers_k10_b', 'answers_k10_c', 'answers_k10_d', ...
     'answers_k10_e', 'answers_k10_f', 'answers_k10_g', 'answers_k10_h', ...
     'answers_k10_i', 'answers_k10_j', 'l_test');
